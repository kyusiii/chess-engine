...
export const DefaultPieces = {
  ...
  KNIGHT: {
    ...
    chessNotation: "N",
    hasMoved: false,
    availableMovements: ["x-1,y+2", "x+1,y+2", "x-1,y-2", "x+1,y-2"],
    position: { x: 0, y: 0 },
  },
  BISHOP: {
    name: "bishop",
  ...
  QUEEN: {
    ...
    chessNotation: "Q",
    hasMoved: false,
    availableMovements: ["lines", "diags"],
    position: { x: 0, y: 0 },
  },
  KING: {
    name: "king",
